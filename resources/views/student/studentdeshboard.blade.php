...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('student')}}/img/favicon.png" rel="icon">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="{{asset('student')}}/img/ui-sam.jpg" class="img-circle" width="80"></a></p>
      ...
      <section class="wrapper">
        <div class="row">
          ...
          <div class="col-lg-3 ds">
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="{{asset('student')}}/img/ui-zac.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
